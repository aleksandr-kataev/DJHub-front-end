    ...
    return (
        <div>
            <div className='p-6 px-8'>
                <img draggable={false} src={Jog} onMouseDown={handleMouseDown} alt="SVG" style={{ transform: `rotate(${calculateJogAngle(jogWheelRotation)}deg)` }} />
            </div>
            <div className='flex justify-around mt-4 text-purple'>
                <button className='bg-white px-4'><svg width="15" height="15" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
